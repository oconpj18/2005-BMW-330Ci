...
var ttBgColor     = "#E3EBF3";
var ttBgImg       = "";           // path to background image;
var ttBorderColor = "rgb(91,189,41)";
var ttBorderWidth = 2;
var ttDelay       = 200;          // time span until tooltip shows up [milliseconds]
var ttFontColor   = "#000000";
var ttFontFace    = "Verdana,Tahoma,sans-serif";
var ttFontSize    = "11px";
...
function tt_Htm(tt, t_id, txt)
{
	...
	t_y += 'left:0px;top:0px;width:'+(t_w+t_shw)+'px;visibility:'+(tt_n4? 'hide' : 'hidden')+';'+t_optx+'">' +
		'<table border="0" cellpadding="0" cellspacing="0"'+(t_bc? (' bgcolor="'+t_bc+'" style="border-spacing: 2px;border-collapse: separate;background:'+t_bc+';"') : '')+' width="'+t_w+'">';
	if(t_tit)
	{
	...
	t_y += '<tr><td><table border="0" cellpadding="'+t_padd+'" cellspacing="'+t_bw+'" width="100%"">' +
		'<tr><td'+(t_bgimg? ' background="'+t_bgimg+'"' : '')+' style="background:'+(t_bgc? (t_bgc+'"') : '')+'; text-align:'+t_algn+';';
